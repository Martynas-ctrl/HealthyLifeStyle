...
import UPDATE_NUTRITION from '../snacks/SnackQueries/SnacksUpdateQuery';


function SnacksUpdate(props) { 

  let foodName, protein, carbs, fat;
  let id = props.id;

  const [updateSnack] = useMutation(UPDATE_NUTRITION);
      ...
      <div key={id}>
        ...
        <Modal show={showModal} backdrop="static" keyboard={false} onHide={formClose}>
          <Modal.Header closeButton>
            <Modal.Title style={{color: "#009688"}}>UPDATE SNACKS</Modal.Title>
          </Modal.Header>
            ...
            <Form onSubmit={updateNutrition}>
              <Form.Group controlId="formBasicEmail">
                ...
                <Form.Text className="text-muted">
                  <p style={{color: '#009688', fontSize: '0.75rem'}}>Update food for snacks</p>
                </Form.Text>
              </Form.Group>
              <Form.Group controlId="formBasicEmail">
                <Form.Control type="text" placeholder="Protein" ref={ value => protein = value} />
                <Form.Text className="text-muted">
                  <p style={{color: '#009688', fontSize: '0.75rem'}}>Update protein for snacks</p>
                </Form.Text>
              </Form.Group>
              <Form.Group controlId="formBasicEmail">
                <Form.Control type="text" placeholder="Carbs" ref={ value => carbs = value} />
                <Form.Text className="text-muted">
                  <p style={{color: '#009688', fontSize: '0.75rem'}}>Update carbs for snacks</p>
                </Form.Text>
              </Form.Group>
              <Form.Group controlId="formBasicEmail">
                <Form.Control type="text" placeholder="Fat" ref={ value => fat = value} />
                <Form.Text className="text-muted">
                  <p style={{color: '#009688', fontSize: '0.75rem'}}>Update fat for snacks</p>
                </Form.Text>
              </Form.Group>
            </Form>
          </Modal.Body>
