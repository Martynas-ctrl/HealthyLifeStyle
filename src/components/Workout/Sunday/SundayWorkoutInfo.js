...
import DELETE_SUNDAY from '../Sunday/SundayDeleteQuery';
import UpdateWorkout from '../Sunday/SundayUpdateWorkout';

function SundayWorkoutInfo(props) {
  const OneRM = props.workoutInfo.weight + (props.workoutInfo.weight * props.workoutInfo.reps * 0.033);
  const [deleteExercise] = useMutation(DELETE_SUNDAY);
...
export default SundayWorkoutInfo;