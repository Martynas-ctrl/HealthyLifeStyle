...
import UPDATE_WORKOUT from '../Thursday/ThursdayUpdateQuery';

function UpdateThursdayWorkout(props) { 
  let exercise, sets, reps, weight;
  let id = props.id;
  const [updateThursdayWorkout] = useMutation(UPDATE_WORKOUT);
...
export default UpdateThursdayWorkout;