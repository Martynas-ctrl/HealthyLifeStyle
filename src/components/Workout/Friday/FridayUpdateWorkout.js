...
import UPDATE_WORKOUT from '../Friday/FridayUpdateQuery';

function UpdateFridayWorkout(props) { 
  let exercise, sets, reps, weight;
  let id = props.id;
  const [updateFridayWorkout] = useMutation(UPDATE_WORKOUT);
...
export default UpdateFridayWorkout;