...
import UPDATE_WORKOUT from '../Saturday/SaturdayUpdateQuery';

function UpdateSaturdayWorkout(props) { 
  let exercise, sets, reps, weight;
  let id = props.id;
  const [updateSaturdayWorkout] = useMutation(UPDATE_WORKOUT);
...
export default UpdateSaturdayWorkout;