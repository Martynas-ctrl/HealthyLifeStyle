...
import DELETE_SATURDAY from '../Saturday/SaturdayDeleteQuery';
import UpdateWorkout from '../Saturday/SaturdayUpdateWorkout';

function SaturdayWorkoutInfo(props) {
  const OneRM = props.workoutInfo.weight + (props.workoutInfo.weight * props.workoutInfo.reps * 0.033);
  const [deleteExercise] = useMutation(DELETE_SATURDAY);
...
export default SaturdayWorkoutInfo;