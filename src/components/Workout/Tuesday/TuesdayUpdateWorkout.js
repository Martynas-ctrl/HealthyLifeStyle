...
import UPDATE_WORKOUT from '../Tuesday/TuesdayUpdateQuery';

function UpdateTuesdayWorkout(props) { 
  let exercise, sets, reps, weight, rest;
  let id = props.id;
  const [updateTuesdayWorkout] = useMutation(UPDATE_WORKOUT);
...
export default UpdateTuesdayWorkout;